...
X2019 <- read.csv("2019.csv", check.names = FALSE)
...
clean_dataset <- X2019[, c("_SEX", "_AGE80", "WEIGHT2", "HEIGHT3", "_RFSMOK3", "_RFBING5", "INCOME2",
                           "EXERANY2", "CHCKDNY2", "HAVARTH4", "TOLDHI2", "_RFHYPE5", "CVDSTRK3",
