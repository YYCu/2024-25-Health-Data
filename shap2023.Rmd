...
X2023 <- read.csv("2023.csv", check.names = FALSE)
```

 Data preprocessing
```{r}
# Select relevant columns
clean_dataset <- X2023[, c("_SEX", "_AGE80", "WEIGHT2", "HEIGHT3", "_RFSMOK3", "_RFBING6", "INCOME3",
                           "EXERANY2", "CHCKDNY2", "HAVARTH4", "TOLDHI3", "_RFHYPE6", "CVDSTRK3",
                           "ASTHMA3", "MENTHLTH", "_RACE", "EDUCA","STRENGTH",
                           "_MICHD")]
...
names(clean_dataset) <- c("SEX", "AGE", "WEIGHT", "HEIGHT", "SMOK", "DRINK", "INCOME",
                          ...
                          "STROKE", "ASTHMA", "MENTAL", "RACE", "EDUCATION", "MUSCLES_EXERCISE", "y")
